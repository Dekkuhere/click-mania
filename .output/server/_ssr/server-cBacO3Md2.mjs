...
import { n as createCsrfMiddleware } from "./server-cBacO3Md.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DjYk467Y.mjs");
...
var manifest = {
	"5d381809dd0bbf8ad37ccfeec641d4c1e0107faf22be59ef252eecd85bb1d194": {
		functionName: "getTopScores_createServerFn_handler",
		importer: () => import("./game.functions-Cma5YbAz.mjs")
	},
	"e91345551373fb92ff854dabc575923814711a7efefb94cbbcaf691774827b57": {
		functionName: "saveScore_createServerFn_handler",
		importer: () => import("./game.functions-Cma5YbAz.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-vGbBLlMd.mjs").then((n) => n.t),
		import("./start-B9LDz2vw.mjs"),
